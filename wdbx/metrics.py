...
RPC_CALL_COUNT = Counter("wdbx_rpc_calls_total", "Total number of WDBX RPC calls", ["method"])
RPC_CALL_LATENCY = Histogram("wdbx_rpc_latency_seconds", "WDBX RPC call latency in seconds", ["method"])
CB_STATE = Gauge("wdbx_circuit_breaker_state", "Circuit breaker state: 0 closed, 1 open")
CB_FAILURES = Gauge(
