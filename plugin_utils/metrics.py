...
REQUEST_COUNTER = Counter(
    'plugin_request_total', 'Total plugin HTTP requests', ['plugin', 'endpoint', 'method']
)
REQUEST_LATENCY = Histogram(
    'plugin_request_latency_seconds', 'Plugin request latency', ['plugin', 'endpoint', 'method']
)
ERROR_COUNTER = Counter(
    'plugin_request_errors_total', 'Total plugin HTTP errors', ['plugin', 'endpoint', 'method']
)
